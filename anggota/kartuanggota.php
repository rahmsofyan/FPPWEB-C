    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <!-- Page Content Holder -->
                <p style="padding-bottom:20px; color:black;"> Menekan tombol proses,berarti meng-generate kartu nama.</p>
                <a href="printcard.php"><button  class="btn btn-success hid">Proses</button></a>
