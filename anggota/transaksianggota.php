    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="#">CETAK TRANSAKSI</a></li>
                ...
                <!-- Page Content Holder -->
                <p style="padding-bottom:20px; color:black;"> Menekan tombol proses,berarti meng-generate transaksi peminjaman terakhir.</p>
                <a href="printtransaction.php"><button  class="btn btn-success hid">Proses</button></a>
