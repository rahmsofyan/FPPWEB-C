...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/adabuku.css">
            ...
            <div id="content">
                ...
                <div>
                  ...
                  while($buku = mysqli_fetch_array($query)){
                    echo '<div class="gallery zoom">';
                    echo '<a target="_blank" href="pinjam.php?B_ID=';
                    echo $buku[B_ID];
                    echo '">';
                    echo '<img src="../assets/buku/';
                    echo "$buku[B_ID].png";
                    echo '" style="width:180px!important; height:250px!important;">';
                    echo '</a>';
                    echo '<div class="desc" style="height:150px;">';
                    echo '<p>';
                    echo $buku[B_JUDUL];
                    echo '</p>';
