    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="#">Pelanggaran Anggota /  Saksi Denda</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
                ...
                <!-- Page Content Holder -->
                <p style="padding-bottom:20px; color:black;"> Menekan tombol proses,berarti memproses seluruh pelanggaran anggota  yang terkena denda hari ini!.
                Yaitu menghapus anggota yang memiliki denda lebih dari 5 kali.</p>
                <?php
                  if($_SESSION[semuahapus]==0)
                  echo '<a href="prosesdenda.php"><button  class="btn btn-success hid">Proses</button></a>';
                  else {
                  echo   '<a class="btn-primary" >Sudah melakukan penghapusan sebelumnya</a>';
                  }
                 ?>
