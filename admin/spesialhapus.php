    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <!-- Page Content Holder -->
                <p style="padding-bottom:20px; color:black;">Menekan tombol hapus,berarti menghapus anggota jika
                  anggota tersebut melakukan pelanggar lebih dari 5 kali.</p>
                <form action="action_hapus_anggota.php" method="post"  enctype="multipart/form-data">
                   <div class="form-group">
                     <label for="A_ID">Masukan ID Anggota :</label>
