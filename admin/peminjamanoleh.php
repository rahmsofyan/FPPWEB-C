                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="#">Pegawai yang bersangkutan</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
            ...
            <!-- Page Content Holder -->
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                      <?php
                      include("config.php");
                      $sql = "SELECT  DISTINCT pegawai.`p_nama`,anggota.`a_nama`
                        FROM anggota LEFT JOIN peminjaman ON anggota.`a_id` = peminjaman.`a_id` LEFT JOIN pegawai ON peminjaman.`p_id` = pegawai.`p_id`";
                      $query = mysqli_query($db, $sql);
                      while($joinpegawai = mysqli_fetch_array($query)){
                        echo "<tr>";
                        echo "<td>".$joinpegawai[p_nama]."</td>";
                        echo "<td>".$joinpegawai[a_nama]."</td>";
                        echo "</tr>";
                      }
