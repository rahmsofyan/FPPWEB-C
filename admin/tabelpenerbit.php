                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      while($penerbit = mysqli_fetch_array($query)){
                        echo "<tr>";
                        echo "<td>".$penerbit[C_ID]."</td>";
                        echo "<td>".$penerbit[C_NAMA]."</td>";
                        echo "<td>".$penerbit[C_ALAMAT]."</td>";
                        echo "<td>".$penerbit[C_EMAIL]."</td>";
                        echo "<td>".$penerbit[C_TELEPON]."</td>";
                        echo "<td>".$penerbit[C_WEB]."</td>";
                      }
