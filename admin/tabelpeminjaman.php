                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="#">Tabel Peminjaman</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      while($peminjaman = mysqli_fetch_array($query)){
                        echo "<tr>";
                        echo "<td>".$peminjaman[E_ID]."</td>";
                        echo "<td>".$peminjaman[P_ID]."</td>";
                        echo "<td>".$peminjaman[A_ID]."</td>";
                        echo "<td>".$peminjaman[B_ID]."</td>";
                        echo "<td>".$peminjaman[E_TANGGAL_PEMINJAMAN]."</td>";
                        echo "<td>".$peminjaman[E_TANGGAL_PENGEMBALIAN]."</td>";
                        echo "<td>".$peminjaman[E_STATUS]."</td>";
                        echo "</tr>";
                      }
