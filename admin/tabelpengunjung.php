            ...
            <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="#">Tabel Pengunjung</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th>Telpon Pengunjung</th>
                        <th>Aktivitas Pengunjung</th>
                    </tr>
                    </thead>
                    <tbody>
                      <?php
                      ...
                      while($pengunjung = mysqli_fetch_array($query)){
                        echo "<tr>";
                        echo "<td>".$pengunjung[Z_ID]."</td>";
                        echo "<td>".$pengunjung[P_ID]."</td>";
                        echo "<td>".$pengunjung[Z_NAMA]."</td>";
                        echo "<td>".$pengunjung[Z_TANGGAL_BERKUNJUNG]."</td>";
                        echo "<td>".$pengunjung[Z_TELPON]."</td>";
                        echo "<td>".$pengunjung[Z_AKTIVITAS]."</td>";
                        echo "</tr>";
                      }
