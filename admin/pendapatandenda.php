    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="#">Pendapatan dari Denda</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
                ...
                <!-- Page Content Holder -->
                <h1 style="padding-bottom:20px;"> Total pendapatan dari Denda yang diperoleh : </h1>

                <?php
                include("config.php");
                $sql = "select total_denda() as jumlah";
                $query = mysqli_query($db, $sql);
                $result = mysqli_fetch_array($query);
                echo '<h1 style="font-size:40px;" class="btn-success">Rp.';
                echo $result[jumlah];
                echo ',00</h1>';
