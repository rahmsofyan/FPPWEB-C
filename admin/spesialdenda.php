    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <!-- Page Content Holder -->
                <p style="padding-bottom:20px; color:black;">Menekan tombol hapus,berarti menghapus denda tersebut,berarti anggota tidak memiliki denda.</p>
                <form action="action_denda_anggota.php" method="post"  enctype="multipart/form-data">
