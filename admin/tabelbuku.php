                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      while($buku = mysqli_fetch_array($query)){
                        ...
                        echo "<td>".$buku[B_ID]."</td>";
                        echo "<td>".$buku[K_ID]."</td>";
                        echo "<td>".$buku[C_ID]."</td>";
                        echo "<td>".$buku[B_JUDUL]."</td>";
                        echo "<td>".$buku[B_TAHUN]."</td>";
                        echo "<td>".$buku[B_TEMPAT_TERBIT]."</td>";
                        echo "<td>".$buku[B_EDISI]."</td>";
                        echo "<td>".$buku[B_PENULIS]."</td>";

                        echo "<td>".$buku[B_EKSEMPLAR]."</td>";
                        echo "<td>".$buku[B_STATUS]."</td>";
                        echo "<td>".$buku[B_ISBN]."</td>";
                        echo "<td>".$buku[B_LOKASI_FISIK]."</td>";
                        echo '<td><img src="../assets/buku/';
                        echo "$buku[B_ID].png";
