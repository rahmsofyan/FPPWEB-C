    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="#">Registrasi Peminjaman</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
                ...
                <!-- Page Content Holder -->
                  <form action="action_pinjam.php" method="post"  enctype="multipart/form-data">
                   <div class="form-group">
                     <label for="A_ID">ID Anggota :</label>
                     <input type="text" class="form-control" id="A_ID" placeholder="Enter ID Anggota" name="A_ID">
                   </div>

                   <div class="form-group">
                     <label for="B_ID">ID Buku :</label>
                     <input type="text" class="form-control" id="B_ID" placeholder="Enter ID Buku" name="B_ID">
                   </div>

                   <div class="form-group">
                     <label for="E_TANGGAL_PINJAM">Tanggal Peminjaman :</label>
                     <input type="date" class="form-control" id="E_TANGGAL_PINJAM" placeholder="Tanggal" name="E_TANGGAL_PINJAM">
                   </div>
