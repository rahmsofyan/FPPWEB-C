                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="#">Denda dari Anggota</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
            ...
            <!-- Page Content Holder -->
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT DISTINCT a.a_id, a.a_nama, b.b_judul, d.d_biaya, d.d_status
                                FROM denda d LEFT JOIN (anggota a LEFT JOIN peminjaman e ON (a.a_id = e.a_id)
                                LEFT JOIN buku b ON (e.b_id = b.b_id))
                           ON (e.e_id = d.e_id)
                           ORDER BY d.d_status DESC ";
