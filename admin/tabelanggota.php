                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      while($anggota = mysqli_fetch_array($query)){
                        echo "<tr>";
                        echo "<td>".$anggota[A_ID]."</td>";
                        echo "<td>".$anggota[A_NAMA]."</td>";
                        echo "<td>".$anggota[A_ALAMAT]."</td>";
                        echo "<td>".$anggota[A_TELPON]."</td>";
                        echo "<td>".$anggota[A_TEMPAT_LAHIR]."</td>";
                        echo "<td>".$anggota[A_TANGGAL_LAHIR]."</td>";
                        echo "<td>".$anggota[A_STATUS]."</td>";
                        echo "</tr>";
                      }
