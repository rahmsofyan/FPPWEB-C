    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <!-- Page Content Holder -->
                <form action="action_anggota.php" method="post"  enctype="multipart/form-data">

                   <div class="form-group">
                     <label for="A_NAMA">Nama :</label>
                     <input type="text" class="form-control" id="A_NAMA" placeholder="Enter Nama" name="A_NAMA">
                   </div>

                   <div class="form-group">
                     <label for="A_ALAMAT">Alamat :</label>
                     <input type="text" class="form-control" id="A_ALAMAT" placeholder="Enter Alamat" name="A_ALAMAT">
                   </div>

                   <div class="form-group">
                     <label for="A_TELPON">No Telp :</label>
                     <input type="text" class="form-control" id="A_TELPON" name="A_TELPON">
                   </div>

                   <div class="form-group">
                     <label for="A_TEMPAT_LAHIR">Tempat Lahir :</label>
                     <input type="text" class="form-control" id="A_TEMPAT_LAHIR" placeholder="isi" name="A_TEMPAT_LAHIR">
                   </div>

                   <div class="form-group">
                     <label for="A_TANGGAL_LAHIR">Tanggal Lahir :</label>
                     <input type="text" class="form-control" id="A_TANGGAL_LAHIR" placeholder="isi" name="A_TANGGAL_LAHIR">
                   </div>

                   <div class="form-group">
                     <label for="A_STATUS">Status/Pekerjaan :</label>
                     <input type="text" class="form-control" id="A_STATUS" placeholder="isi" name="A_STATUS">
                   </div>

                   <div class="form-group">
                     <label for="A_EMAIL">Email :</label>
                     <input type="email" class="form-control" id="A_EMAIL" placeholder="isi" name="A_EMAIL">
                   </div>

                   <div class="form-group">
                     <label for="A_KELAMIN">Kelamin (L/P) :</label>
                     <input type="text" class="form-control" id="A_KELAMIN" placeholder="isi" name="A_KELAMIN">
                   </div>
