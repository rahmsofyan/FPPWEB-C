    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                Yaitu menambah denda pada tiap anggota.</p>
                <?php
                  if($_SESSION[tambahdenda]==0)
                  echo '<a href="prosesdenda.php"><button  class="btn btn-success hid">Proses</button></a>';
                  else {
                  echo   '<a class="btn-primary" >Sudah melakukan pendedaan sebelumnya</a>';
                  }
                 ?>
